...
const SERVICE_NAME = 'SchedulerService';
const router = Router();
...
router.get('/tasks', authMiddleware, catchAsync(async (req: AuthRequest, res: Response) => {
    try {
        ...
        logErrorReport('listTasks', SERVICE_NAME, error, ERROR_CODES.SCHEDULER_CRUD_FAILED);
        res.status(500).json(ApiResponse.error({ message: 'Failed to fetch tasks' }));
    }
}));
...
router.post('/tasks', authMiddleware, catchAsync(async (req: AuthRequest, res: Response) => {
    try {
        ...
        logErrorReport('createTask', SERVICE_NAME, error, ERROR_CODES.SCHEDULER_CRUD_FAILED);
        res.status(500).json(ApiResponse.error({ message: 'Failed to create task' }));
    }
}));
...
router.patch('/tasks/:id', authMiddleware, catchAsync(async (req: AuthRequest, res: Response) => {
    try {
        ...
        logErrorReport('updateTask', SERVICE_NAME, error, ERROR_CODES.SCHEDULER_CRUD_FAILED);
        res.status(500).json(ApiResponse.error({ message: 'Failed to update task' }));
    }
}));
...
router.delete('/tasks/:id', authMiddleware, catchAsync(async (req: AuthRequest, res: Response) => {
    try {
        ...
        logErrorReport('deleteTask', SERVICE_NAME, error, ERROR_CODES.SCHEDULER_CRUD_FAILED);
        res.status(500).json(ApiResponse.error({ message: 'Failed to delete task' }));
    }
}));
...
router.get('/habits', authMiddleware, catchAsync(async (req: AuthRequest, res: Response) => {
    try {
        ...
        logErrorReport('listHabits', SERVICE_NAME, error, ERROR_CODES.SCHEDULER_CRUD_FAILED);
        res.status(500).json(ApiResponse.error({ message: 'Failed to fetch habits' }));
    }
}));
...
router.post('/habits', authMiddleware, catchAsync(async (req: AuthRequest, res: Response) => {
    try {
        ...
        logErrorReport('createHabit', SERVICE_NAME, error, ERROR_CODES.SCHEDULER_CRUD_FAILED);
        res.status(500).json(ApiResponse.error({ message: 'Failed to create habit' }));
    }
}));
...
router.get('/events', authMiddleware, catchAsync(async (req: AuthRequest, res: Response) => {
    try {
        ...
        logErrorReport('listEvents', SERVICE_NAME, error, ERROR_CODES.SCHEDULER_CRUD_FAILED);
        res.status(500).json(ApiResponse.error({ message: 'Failed to fetch events' }));
    }
}));
...
router.get('/settings', authMiddleware, catchAsync(async (req: AuthRequest, res: Response) => {
    try {
        ...
        logErrorReport('getSettings', SERVICE_NAME, error, ERROR_CODES.SCHEDULER_CRUD_FAILED);
        res.status(500).json(ApiResponse.error({ message: 'Failed to fetch settings' }));
    }
}));
...
router.post('/optimize', authMiddleware, catchAsync(async (req: AuthRequest, res: Response) => {
    try {
        ...
        logErrorReport('optimizeSchedule', SERVICE_NAME, error, ERROR_CODES.SCHEDULER_OPTIMIZE_FAILED);
        res.status(500).json(ApiResponse.error({ message: 'Failed to optimize schedule' }));
    }
}));
